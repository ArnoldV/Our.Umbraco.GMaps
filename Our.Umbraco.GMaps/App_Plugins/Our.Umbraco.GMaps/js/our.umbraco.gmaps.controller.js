angular.module("umbraco").controller("Our.Umbraco.GMaps.Controller", ["$scope", "Our.Umbraco.GMaps.Factory", function ($scope, mapsFactory) {
	'use strict';

	$scope.apiKey = '';
	$scope.defaultLocation = '52.379189, 4.899431'; // Amsterdam Central Station
	...
	if ($scope.apiKey !== '') {
		...
		console.warn("No Google Maps API key set, Our.Umbraco.GMaps can't load.");
	}
}]);
