...
{
    internal class RegisterServerVariables : IComponent
    {
        ...
        private void ServerVariablesParser_Parsing(object sender, Dictionary<string, object> e)
        {
            ...
            string gMapsBaseUrl = urlHelper.GetUmbracoApiServiceBaseUrl<GoogleMapsController>(controller => controller.GetSettings());
